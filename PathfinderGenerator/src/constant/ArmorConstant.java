...
public class ArmorConstant {
	...
	public static Data<ArmorSpecialPropertie> shieldSpecialProperties1(){
		...
		res.add(new Tuple<ArmorSpecialPropertie, Integer>(new ArmorSpecialPropertie("Bélier", 1), 9));
	...
	public static Data<ArmorSpecialPropertie> shieldSpecialProperties5(){
		...
		res.add(new Tuple<ArmorSpecialPropertie, Integer>(new ArmorSpecialPropertie("Résistance suprême aux énergies destructives", 66000), 17));
